/**
 * Logi de fonctionnement.
 * 1- stocker tous les fichiers selectionné dans la value de l'input.
 * 2- Créer un objet image pour chaque image selectionnée et l'ajouter dans le composant de 
...
class FilesChooser extends HTMLInputElement {
    ...
    createFileItem(file_content) {
        ...
        item.addEventListener('mouseleave', () => {label.style.display = 'none'})
